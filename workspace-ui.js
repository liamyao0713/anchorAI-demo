(function () {
  ...
  const UI_TEXT = {
    en: {
      ...
      // Flanking labels on a slider, not button captions -- the gallery uses
      // "Track"/"Clean" and the long forms pushed the panel title to an ellipsis.
      clean: "Clean",
      tracked: "Track",
      cleanAria: "Clean answer",
      trackedAria: "Show changes",
